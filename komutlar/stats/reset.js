...
exports.run = async (client, message, args) => {
    if(!message.member.permissions.has("ADMINISTRATOR") && !message.member.permissions.has("MANAGE_GUILD")) return message.reply("Bu Komutu Kullanmak İçin Gerekli İzinlere Sahip Değilsin.");
    let deleteMessages = [];
