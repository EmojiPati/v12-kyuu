...
.addField(`> ${dbl} __Bot Rol__ » \`${prefix}botlist-bot\` `,`➥ ***Bot Onaylandığında Bota Verilecek Rolü Ayarlar***`)
.addField(`> ${dbl} __Developer Rol__ » \`${prefix}botlist-developer\` `,`➥ ***Bot Onaylandığında Sahibine Verilecek Rolü***`)
.addField(`> ${dbl} __Yetkili Rol__ » \`${prefix}botlist-yetkili\` `,`➥ ***Bot Onaylıyacak Kişinin Rolünü Ayarlar***`)
