...
.addField(`> ${list} __Çekiliş Sistemi__ » \`${prefix}çekiliş-sistemi\` `,`➥ ***Gelişmiş Çekiliş Sistemi***`)
.addField(`> ${list} __Seviye Sistemi__ » \`${prefix}seviye-sistemi\` `,`➥ ***Gelişmiş Seviye Sistemi***`)
.addField(`> ${list} __Reaksiyon Sistemi__ » \`${prefix}reaksiyon-sistemi\` `,`➥ ***Gelişmiş Seviye Sistemi***`)
